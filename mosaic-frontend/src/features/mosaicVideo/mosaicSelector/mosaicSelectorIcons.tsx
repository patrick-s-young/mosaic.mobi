...
export const TwoTilesIcon = (props: SvgIconProps) => 
  <SvgIcon {...props}>
...
export const ThreeTilesIcon = (props: SvgIconProps) => 
  <SvgIcon {...props}>
    <rect x="0" y="0" width="24" height="24"></rect>
...
export const FourTilesIcon = (props: SvgIconProps) => 
  <SvgIcon {...props}>
    <rect x="0" y="0" width="24" height="24"></rect>
...
export const SixTilesIcon = (props: SvgIconProps) => 
  <SvgIcon {...props}>
    <rect x="0" y="0" width="24" height="24"></rect>
...
export const NineTilesIcon = (props: SvgIconProps) => 
  <SvgIcon {...props}>
    <rect x="0" y="0" width="24" height="24"></rect>
