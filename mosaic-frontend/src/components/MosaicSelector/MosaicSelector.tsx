...
const MosaicSelector: React.FC<MosaicSelectorProps> = ({ width }) => {
  ...
  return (
    <div className={classes.centerScreen} style={{ width }}>
      ...
      >
        <Tab icon={<TwoTilesIcon fontSize='large' className='mosaicSelector__tileIcon' />} value={2} style={{ minWidth: width / 5 }} aria-label="two-tile mosaic" />
        <Tab icon={<ThreeTilesIcon fontSize='large' className='mosaicSelector__tileIcon' />} value={3} style={{ minWidth: width / 5 }} aria-label="three-tile mosaic" />
        <Tab icon={<FourTilesIcon fontSize='large' className='mosaicSelector__tileIcon' />} value={4} style={{ minWidth: width / 5 }} aria-label="four-tile mosaic" />
        <Tab icon={<SixTilesIcon fontSize='large' className='mosaicSelector__tileIcon' />} value={6} style={{ minWidth: width / 5 }} aria-label="six-tile mosaic" />
        <Tab icon={<NineTilesIcon fontSize='large' className='mosaicSelector__tileIcon' />} value={9} style={{ minWidth: width / 5 }} aria-label="nine-tile mosaic" />
      </Tabs>
  </div>
  );
}
